...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 123141k2m1k312</DialogTitle>
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">61 99999-9999</TableCell>
            </TableRow>
            <TableRow>
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell className="text-right">R$ 121,78</TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Pizza Mussarela</TableCell>
              <TableCell className="text-right">2</TableCell>
              <TableCell className="text-right">R$ 50,90</TableCell>
              <TableCell className="text-right">R$ 101,78</TableCell>
            </TableRow>
          </TableBody>
          <TableFooter>
            <TableRow>
